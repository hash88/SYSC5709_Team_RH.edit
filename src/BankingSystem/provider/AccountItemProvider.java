...
/**
 * This is the item provider adapter for a {@link BankingSystem.Account} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AccountItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BankingSystemPackage.Literals.ACCOUNT__ACCOUNT_NUMBER,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BankingSystemPackage.Literals.ACCOUNT__BALANCE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Account)object).getAccountNumber();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Account.class)) {
			case BankingSystemPackage.ACCOUNT__ACCOUNT_NUMBER:
